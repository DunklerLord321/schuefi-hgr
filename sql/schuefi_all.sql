...
--
ALTER TABLE `paare`
  ADD CONSTRAINT `paare_ibfk_1` FOREIGN KEY (`id_lehrer`) REFERENCES `lehrer` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `paare_ibfk_2` FOREIGN KEY (`id_schueler`) REFERENCES `schueler` (`id`) ON UPDATE CASCADE;
--
...
(6, 'Yannik', 'Weber', 'yajo10@yahoo.de', '$2y$10$rs27PVrKUl5I8hVP0V/U5eAjLoHHw5llQCZGbICaEb2R2J5TuypSC', 'root', '2017-02-13 10:42:52', '2017-02-13 10:42:52', '2017-02-17 17:17:08', 1, 4, '2017-03-06 13:54:43'),
(7, 'Christopher', 'Stäglich', 'joyajo108@gmail.com', '$2y$10$.3nbeE6OajtDUiFqj0wD0ePAn/3.rF0W0XueUzvh7xMTGuJT8JlWO', 'normal', '2017-02-14 09:37:42', '2017-02-14 09:37:42', '2017-02-17 17:17:08', 0, 2, '2017-02-27 18:01:59'),
(8, 'Vorsitzender', 'Schülerfirma', 'schuelerfirma.hgr@gmx.de', '$2y$10$Wu5yJYPTFO6Qs.YWUnf6jepPDRCXED5A/hf11BWABIPo69vBOL3By', 'normal', '2017-02-27 17:45:55', '2017-02-27 17:45:55', '2017-02-27 16:45:55', 0, 0, '2017-02-27 17:21:51'),
(9, 'gast', 'Schülerfirma', 'gast@gast.de', '$2y$10$jFttMshNesyHH86CQ0XOwegRO7bQluzN2pRd.3xSuGKrToCxLYtqy', 'view-only', '2017-03-02 15:42:58', '2017-03-02 15:42:58', '2017-03-02 14:42:58', 0, 2, '2017-03-02 20:07:45');
