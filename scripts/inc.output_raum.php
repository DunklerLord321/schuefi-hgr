...
//			echo "<table class=\"table1\"><tr><th>Zimmer</th><th>Tag</th><th>Stunde</th><th>Status</th><th></th><th></th></tr>";
		...
		while ($result){
			echo "<tr><td>".$result['nummer']."</td><td>".get_name_of_day($result['tag'])."</td><td>".$result['stunde']."</td><td>".($result['belegung'] != 1 ? "frei" : "<a href=\"index.php?page=output&paare=1&raumfilter=".$result['id']."\" class=\"links2\">belegt durch Nachhilfepaar</a>")."</td><td>";
