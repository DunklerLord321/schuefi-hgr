...
if(strcmp($_SESSION['account'],"root") != 0) {
	$showFormular = false;
	echo "<br><i>Sie sind kein Admin und dürfen deshalb keinen neuen Nutzen hinzufügen!</i>";
}
if (isset ( $_GET ['register'] ) && strcmp($_SESSION['account'],"root") == 0) {
	$error = false;
	$email = $_POST ['email'];
	$vname = $_POST['vname'];
	$nname = $_POST['nname'];
...
<div id="formular">
	<form action="?register=1" method="post">
		Vorname:<br>
		<input type="text" size="40" maxlength="49" name="vname" autofocus><br> <br> 
		Nachname:<br>
		<input type="text" size="40" maxlength="49" name="nname"><br> <br> 
		E-Mail:<br>
		<input type="email" size="40" maxlength="250" name="email"><br> <br>
		Accounttype:<br>
		<input type="radio" name="account" value="view-only">Nur lesend 
		<input type="radio" name="account" value="normal" checked="checked">Schreibend und Lesend 
		<input type="radio" name="account" value="root">Admin<br><br>
		Passwort:<br>
		<input type="password" size="40" maxlength="250" name="passwort"><br><br>
		Passwort wiederholen:<br> <input type="password" size="40"
			maxlength="250" name="passwort2"><br> <br>
